...
Il problema è molto studiato nella versione senza i vincoli di Multiple Choice, sino dal 1977
...
Ogni termine della funzione obiettivo è diverso da zero se entrambe le variabili $x_i , x_j$ valgono 1 ovvero entrambi i vertici associati fanno parte della clique.
...
Possiamo ottenere un modello lineare intero, più facile da risolvere introducendo $n^2$ nuove variabili decisionali binarie $y_{ij}$ che prendono il valore del prodotto $x_ix_j$. Per imporre questa condizione è necessario introdurre 3 nuovi gruppi di vincoli.
...
Abbiamo inoltre verificato che l'euristica di Tabu Search è stata in grado di determinare la soluzione ottima nel 84% delle istanze.
